...
<template>
  <div id="app">
    ...
    >
      ...
      >
        <a href="#" @click.prevent="route('playgroundDashboard')">
          <img
      ...
      <b-collapse id="nav-collapse" is-nav style="width: 30%">
        <b-navbar-nav class="ml-auto">
          <a
            class="mr-4"
            href="#"
            @click.prevent="route('playgroundDashboard')"
            style="color: grey; margin-top: 0.8em"
            title="SSI Playground"
            v-if="
          ...
          <a
            class="mr-4"
            href="https://entity.dashboard.hypersign.id"
            target="_blank"
            style="color: grey; margin-top: 0.8em"
          ...
          <a
            class="mr-3"
            href="https://docs.hypersign.id/entity-studio/ssi-playground"
            target="blank"
            style="color: grey; margin-top: 0.8em"
            title="Documentation"
          >
